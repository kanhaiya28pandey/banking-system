    ...
    <div style={{ background: '#f5f5f5', minHeight: '100vh', padding: '40px 20px' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto', background: 'white', borderRadius: '16px', padding: '40px', boxShadow: '0 4px 20px rgba(0,0,0,0.1)' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          <h1 style={{ fontSize: '28px', color: '#F5C842', marginBottom: '8px' }}>🏦 Create Your Account</h1>
          <p style={{ color: '#666', fontSize: '14px' }}>Step {currentPhase} of 5</p>
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '12px', marginBottom: '12px' }}>
              <div style={colStyle}>
                ...
                <input type="text" value={phase1.firstName} onChange={e => setPhase1({...phase1, firstName: e.target.value})} placeholder="First name" style={inputStyle} />
              </div>
              <div style={colStyle}>
                <label style={labelStyle}>Middle Name</label>
                <input type="text" value={phase1.middleName} onChange={e => setPhase1({...phase1, middleName: e.target.value})} placeholder="Middle name" style={inputStyle} />
              </div>
              <div style={colStyle}>
                <label style={labelStyle}>Last Name *</label>
                <input type="text" value={phase1.lastName} onChange={e => setPhase1({...phase1, lastName: e.target.value})} placeholder="Last name" style={{...inputStyle, marginRight: 0}} />
              </div>
            </div>

            <div style={{ marginBottom: '12px' }}>
              <label style={labelStyle}>Father's Name *</label>
              <input type="text" value={phase1.fathersName} onChange={e => setPhase1({...phase1, fathersName: e.target.value})} placeholder="Father's name" style={inputStyle} />
            </div>

            <div style={{ display: 'flex', gap: '12px', marginBottom: '12px' }}>
              <div style={colStyle}>
                <label style={labelStyle}>Gender *</label>
                <select value={phase1.gender} onChange={e => setPhase1({...phase1, gender: e.target.value})} style={inputStyle}>
              ...
              <div style={colStyle}>
                ...
                <input type="date" value={phase1.dateOfBirth} onChange={e => setPhase1({...phase1, dateOfBirth: e.target.value})} style={{...inputStyle, marginRight: 0}} />
              </div>
            </div>

            <div style={{ marginBottom: '12px' }}>
              <label style={labelStyle}>Address *</label>
              <textarea value={phase1.address} onChange={e => setPhase1({...phase1, address: e.target.value})} placeholder="Street address" style={{...inputStyle, minHeight: '80px', fontFamily: 'Arial'}} />
            </div>

            <div style={{ display: 'flex', gap: '12px', marginBottom: '12px' }}>
              <div style={colStyle}>
                <label style={labelStyle}>City *</label>
                <input type="text" value={phase1.city} onChange={e => setPhase1({...phase1, city: e.target.value})} placeholder="City" style={inputStyle} />
              </div>
              <div style={colStyle}>
                <label style={labelStyle}>State *</label>
                <select value={phase1.state} onChange={e => setPhase1({...phase1, state: e.target.value})} style={inputStyle}>
              ...
              <div style={colStyle}>
                ...
                <input type="text" value={phase1.pinCode} onChange={e => setPhase1({...phase1, pinCode: e.target.value})} placeholder="6-digit pin" style={{...inputStyle, marginRight: 0}} />
              </div>
            </div>
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '12px', marginBottom: '12px' }}>
              <div style={colStyle}>
                ...
                <select value={phase2.religion} onChange={e => setPhase2({...phase2, religion: e.target.value})} style={inputStyle}>
              ...
              <div style={colStyle}>
                ...
                <select value={phase2.category} onChange={e => setPhase2({...phase2, category: e.target.value})} style={{...inputStyle, marginRight: 0}}>
            ...
            <div style={{ marginBottom: '12px' }}>
              ...
              <select value={phase2.incomeRange} onChange={e => setPhase2({...phase2, incomeRange: e.target.value})} style={inputStyle}>
            ...
            <div style={{ marginBottom: '12px' }}>
              ...
              <select value={phase2.educationalQualification} onChange={e => setPhase2({...phase2, educationalQualification: e.target.value})} style={inputStyle}>
            ...
            {phase2.educationalQualification === 'Other' && (
              <div style={{ marginBottom: '12px' }}>
                <input type="text" value={phase2.educationOtherDetails} onChange={e => setPhase2({...phase2, educationOtherDetails: e.target.value})} placeholder="Please specify" style={inputStyle} />
              </div>
            )}

            <div style={{ marginBottom: '12px' }}>
              <label style={labelStyle}>Occupation *</label>
              <select value={phase2.occupation} onChange={e => setPhase2({...phase2, occupation: e.target.value})} style={inputStyle}>
            ...
            {phase2.occupation === 'Other' && (
              <div style={{ marginBottom: '12px' }}>
                <input type="text" value={phase2.occupationOtherDetails} onChange={e => setPhase2({...phase2, occupationOtherDetails: e.target.value})} placeholder="Please specify" style={inputStyle} />
              </div>
            )}
            ...
            <div style={{ display: 'flex', gap: '12px', marginBottom: '12px' }}>
              <div style={colStyle}>
                ...
                <input type="text" value={phase2.panNumber} onChange={e => setPhase2({...phase2, panNumber: e.target.value.toUpperCase()})} placeholder="e.g., AAAPL5055K" style={inputStyle} />
              </div>
              <div style={colStyle}>
                <label style={labelStyle}>Aadhaar Number *</label>
                <input type="text" value={phase2.aadhaarNumber} onChange={e => setPhase2({...phase2, aadhaarNumber: e.target.value})} placeholder="12-digit number" style={{...inputStyle, marginRight: 0}} />
              </div>
            </div>

            <div style={{ display: 'flex', gap: '20px', marginBottom: '20px', background: '#f9f9f9', padding: '16px', borderRadius: '8px' }}>
              <label style={{ flex: 1, margin: 0, display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer', fontSize: '14px', fontWeight: '600', color: '#333' }}>
                <input type="checkbox" checked={phase2.seniorCitizen} onChange={e => setPhase2({...phase2, seniorCitizen: e.target.checked})} style={{ width: '18px', height: '18px', cursor: 'pointer' }} />
                👴 Senior Citizen
              </label>
              <label style={{ flex: 1, margin: 0, display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer', fontSize: '14px', fontWeight: '600', color: '#333' }}>
                <input type="checkbox" checked={phase2.existingAccountHolder} onChange={e => setPhase2({...phase2, existingAccountHolder: e.target.checked})} style={{ width: '18px', height: '18px', cursor: 'pointer' }} />
        ...
        {currentPhase === 4 && (
          <div>
            <h2 style={{ color: '#333', marginBottom: '20px' }}>🔐 Phase 4: Security Setup</h2>

            <div style={{ marginBottom: '12px' }}>
              <label style={labelStyle}>Create Password *</label>
              <input type="password" value={phase4.password} onChange={e => setPhase4({...phase4, password: e.target.value})} placeholder="Min 8 chars, 1 uppercase, 1 digit" style={inputStyle} />
              <small style={{ color: '#666' }}>Password must contain: uppercase, lowercase, digit</small>
            </div>

            <div style={{ marginBottom: '12px' }}>
              <label style={labelStyle}>Confirm Password *</label>
              <input type="password" value={phase4.confirmPassword} onChange={e => setPhase4({...phase4, confirmPassword: e.target.value})} placeholder="Confirm password" style={inputStyle} />
              {phase4.password !== phase4.confirmPassword && phase4.confirmPassword && <p style={{ color: '#FF6B6B', fontSize: '12px' }}>❌ Passwords don't match</p>}
            </div>
            ...
            <div style={{ display: 'flex', gap: '12px', marginTop: '30px' }}>
              ...
              <button onClick={handlePhase4Submit} style={{
                flex: 1, padding: '14px', background: '#F5C842', border: 'none', borderRadius: '8px',
                cursor: 'pointer', fontWeight: 'bold'
              }} disabled={loading || phase4.password !== phase4.confirmPassword || phase4.transactionPin !== phase4.confirmTransactionPin || phase4.password.length < 8 || phase4.transactionPin.length !== 4}>
